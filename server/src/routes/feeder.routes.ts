 ...
 */
router.post('/feeder/aircraft', async (req: Request, res: Response, _next: NextFunction) => {
 ...
 */
router.post('/feeder/register', async (req: Request, res: Response, _next: NextFunction) => {
  const {
  ...
  try {
    ...
    const err = error as Error;
    logger.error('Error registering feeder', { feeder_id, error: err.message });
    return res.status(500).json({
      success: false,
 ...
 */
router.post('/feeder/stats', async (req: Request, res: Response, _next: NextFunction) => {
 ...
 */
router.put('/feeder/last-seen', async (req: Request, res: Response, _next: NextFunction) => {
 ...
 */
router.get('/feeder/me', async (req: Request, res: Response, _next: NextFunction) => {
  try {
