...
class PostgresRepository {
  ...
  async createMainTable(): Promise<void> {
    return this.schema.createMainTable();
  }

  async createAircraftStatesIndexes(): Promise<void> {
    return this.schema.createAircraftStatesIndexes();
  }

  async createHistoryTable(): Promise<void> {
    return this.schema.createHistoryTable();
  }
  ...
  async createFeedersTable(): Promise<void> {
    return this.schema.createFeedersTable();
  }

  async createFeederStatsTable(): Promise<void> {
    return this.schema.createFeederStatsTable();
  }

  async addFeederColumnsToAircraftStates(): Promise<void> {
    return this.schema.addFeederColumnsToAircraftStates();
  }

  async addFeederColumnsToAircraftStatesHistory(): Promise<void> {
    return this.schema.addFeederColumnsToAircraftStatesHistory();
  }
  ...
  async upsertAircraftState(state: any): Promise<void> {
    return this.aircraft.upsertAircraftState(state);
  }

  async findAircraftByIdentifier(identifier: string): Promise<any> {
    return this.aircraft.findAircraftByIdentifier(identifier);
  }
  ...
  async updateAircraftCategory(icao24: string, category: number | null): Promise<void> {
    return this.aircraft.updateAircraftCategory(icao24, category);
  }

  async updateAircraftCallsign(icao24: string, callsign: string | null): Promise<void> {
    return this.aircraft.updateAircraftCallsign(icao24, callsign);
  }

  async findAircraftHistory(icao24: string, startTime?: Date | null, endTime?: Date | null): Promise<any> {
  ...
  async findRecentAircraftWithoutRoutes(minLastContact: number, limit?: number): Promise<any> {
    return this.aircraft.findRecentAircraftWithoutRoutes(minLastContact, limit);
  }
  ...
  async upsertAircraftStateWithPriority(
    ...
    return this.aircraft.upsertAircraftStateWithPriority(
      state,
      feederId,
      ingestionTimestamp,
      dataSource,
  ...
  async cacheRoute(cacheKey: string, routeData: any): Promise<void> {
    return this.route.cacheRoute(cacheKey, routeData);
  }

  async getCachedRoute(cacheKey: string): Promise<any> {
    return this.route.getCachedRoute(cacheKey);
  }

  async findHistoricalRoute(callsign: string, departureIcao: string): Promise<any> {
    return this.route.findHistoricalRoute(callsign, departureIcao);
  }

  async findHistoricalRouteByIcao24(icao24: string, departureIcao: string): Promise<any> {
    return this.route.findHistoricalRouteByIcao24(icao24, departureIcao);
  }

  async storeRouteHistory(routeData: any): Promise<void> {
    return this.route.storeRouteHistory(routeData);
  }

  async findFlightsNeedingBackfill(limit?: number): Promise<any> {
  ...
  async findFlightsMissingAllRecent(limit?: number): Promise<any> {
    return this.route.findFlightsMissingAllRecent(limit);
  }

  async updateFlightHistoryById(id: number, fields: any): Promise<void> {
    return this.route.updateFlightHistoryById(id, fields);
  }
  ...
  async getHistoricalRoutes(
    ...
    return this.route.getHistoricalRoutes(icao24, startDate, endDate, limit);
  }

  async getLatestRouteHistory(icao24: string, callsign?: string | null): Promise<any> {
    return this.route.getLatestRouteHistory(icao24, callsign);
  }

  async getRouteStats(): Promise<any> {
    return this.route.getRouteStats();
  }
  ...
  async getUserByGoogleId(googleId: string): Promise<any> {
    return this.user.getUserByGoogleId(googleId);
  }
  ...
  async updateUserFeederProviderStatus(userId: number, isFeederProvider: boolean): Promise<any> {
  ...
  async registerFeeder(feederData: any): Promise<any> {
    return this.feeder.registerFeeder(feederData);
  }
  ...
  async getFeederByApiKey(apiKey: string): Promise<any> {
    return this.feeder.getFeederByApiKey(apiKey);
  }

  // Delegate API key methods
  async createApiKey(data: any): Promise<any> {
    return this.apiKey.createApiKey(data);
  }

  async getApiKeyByHash(keyHash: string): Promise<any> {
    return this.apiKey.getApiKeyByHash(keyHash);
  }

  async validateApiKey(plainKey: string): Promise<any> {
    return this.apiKey.validateApiKey(plainKey);
  }

  async getApiKeyById(keyId: string): Promise<any> {
    return this.apiKey.getApiKeyById(keyId);
  }

  async listApiKeys(filters?: any): Promise<any> {
    return this.apiKey.listApiKeys(filters);
  }
  ...
  async findAirportsNearPoint(
    ...
    return this.airport.findAirportsNearPoint(latitude, longitude, radiusKm, airportType);
  }

  async findAirportByCode(code: string): Promise<any> {
    return this.airport.findAirportByCode(code);
  }
  ...
  async findAirportsInBounds(
    ...
    return this.airport.findAirportsInBounds(latmin, lonmin, latmax, lonmax, airportType, limit);
  }
  ...
  async findNavaidsNearPoint(
    ...
    return this.airport.findNavaidsNearPoint(latitude, longitude, radiusKm, navaidType);
  }
